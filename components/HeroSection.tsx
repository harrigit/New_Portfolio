      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="space-y-12 z-10 my-24 lg:my-32 col-span-2 lg:col-span-1 order-2 lg:order-1">
          ...
          <div className="grid grid-cols-4 md:grid-cols-5  gap-x-4">
            <button
              type="button"
              className="px-5 col-span-2 py-3 shadow-md rounded-3xl text-slate-200 glow bg-gradient-to-r from-secondary to-accent"
            ...
            <button
              type="button"
              className="px-5 col-span-2 py-3 shadow-md rounded-3xl text-slate-200 glow bg-gradient-to-r from-accent to-secondary"
