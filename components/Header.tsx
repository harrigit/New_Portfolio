...
function Header() {
  return (
    <div className='grid grid-cols-6 gap-y-4 py-4 bg-primary z-10 mx-8 xl:mx-auto justify-between'>
      ...
      <div className='order-3 xl:order-2 col-span-6 xl:col-span-2 flex justify-around cursor-pointer'>
